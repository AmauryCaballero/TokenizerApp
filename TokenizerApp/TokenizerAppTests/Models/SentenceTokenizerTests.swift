...
class SentenceTokenizerTests: XCTestCase {
    ...
    func testTokenizerWithEmptyAndWhitespaceOnlySentences() throws {
        ...
        let emptyTokens = try tokenizer.tokenize(sentence: emptySentence, language: "en")
        let whitespaceTokens = try tokenizer.tokenize(sentence: whitespaceSentence, language: "en")
